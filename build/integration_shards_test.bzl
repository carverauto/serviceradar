...
def _integration_shards_topology_test_impl(ctx):
    ...
    asserts.equals(env, 7, serial_lane_count_for_capacity(197, 151))
    asserts.equals(env, 7, serial_lane_count_for_capacity(107, 151))
    asserts.equals(env, 6, serial_lane_count_for_capacity(106, 151))
    asserts.equals(env, 1, serial_lane_count_for_capacity(27, 151))
    ...
    asserts.equals(env, 151, len(serial_counts))
