...
def _integration_shards_topology_test_impl(ctx):
    ...
    asserts.equals(env, 7, serial_lane_count_for_capacity(197, 132))
    asserts.equals(env, 7, serial_lane_count_for_capacity(107, 132))
    asserts.equals(env, 6, serial_lane_count_for_capacity(106, 132))
    asserts.equals(env, 1, serial_lane_count_for_capacity(27, 132))
    ...
    asserts.equals(env, 127, len(async_sources))
    asserts.equals(env, 132, len(serial_counts))
    asserts.equals(env, 259, len(selected_sources))
