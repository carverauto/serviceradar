...
def _integration_shards_topology_test_impl(ctx):
    ...
    asserts.equals(env, 7, serial_lane_count_for_capacity(197, 152))
    asserts.equals(env, 7, serial_lane_count_for_capacity(107, 152))
    asserts.equals(env, 6, serial_lane_count_for_capacity(106, 152))
    asserts.equals(env, 1, serial_lane_count_for_capacity(27, 152))
    ...
    asserts.equals(env, 152, len(serial_counts))
