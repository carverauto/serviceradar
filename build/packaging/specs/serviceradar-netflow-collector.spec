...
install -m 644 %{_sourcedir}/build/packaging/netflow-collector/systemd/serviceradar-netflow-collector.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/build/packaging/netflow-collector/config/netflow-collector.json %{buildroot}/etc/serviceradar/
