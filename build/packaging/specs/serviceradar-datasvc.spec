...
install -m 644 %{_sourcedir}/build/packaging/datasvc/systemd/serviceradar-datasvc.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/build/packaging/datasvc/config/datasvc.json %{buildroot}/etc/serviceradar/
