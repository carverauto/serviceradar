...
install -m 644 %{_sourcedir}/build/packaging/event-writer/systemd/serviceradar-event-writer.service %{buildroot}/lib/systemd/system/serviceradar-event-writer.service
install -m 644 %{_sourcedir}/build/packaging/event-writer/config/db-event-writer.json %{buildroot}/etc/serviceradar/consumers/
