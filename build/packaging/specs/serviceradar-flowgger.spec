...
install -m 644 %{_sourcedir}/build/packaging/flowgger/systemd/serviceradar-flowgger.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/build/packaging/flowgger/config/flowgger.toml %{buildroot}/etc/serviceradar/
