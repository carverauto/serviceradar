...
install -m 644 %{_sourcedir}/build/packaging/zen/systemd/serviceradar-zen.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/build/packaging/zen/config/zen-consumer.json %{buildroot}/etc/serviceradar/consumers/
install -m 644 %{_sourcedir}/build/packaging/zen/rules/*.json %{buildroot}/etc/serviceradar/zen/rules/
