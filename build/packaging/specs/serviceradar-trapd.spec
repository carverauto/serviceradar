...
install -m 644 %{_sourcedir}/build/packaging/trapd/systemd/serviceradar-trapd.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/build/packaging/trapd/config/trapd.json %{buildroot}/etc/serviceradar/
