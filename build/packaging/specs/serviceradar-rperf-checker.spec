...
# Install the binary (assumes binary is built at /src/rust/checkers/rperf-client/target/release/serviceradar-rperf-checker)
...
install -m 644 %{_sourcedir}/build/packaging/rperf-checker/systemd/serviceradar-rperf-checker.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/build/packaging/rperf-checker/config/checkers/rperf.json %{buildroot}/etc/serviceradar/checkers/
