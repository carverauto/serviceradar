...
# Install config file
install -m 644 %{_sourcedir}/build/packaging/faker/config/faker.json %{buildroot}/usr/share/serviceradar/faker/config/

# Install systemd service file
install -m 644 %{_sourcedir}/build/packaging/faker/systemd/serviceradar-faker.service %{buildroot}/usr/share/serviceradar/faker/systemd/
