...
install -m 644 %{_sourcedir}/build/packaging/goflow2/systemd/serviceradar-goflow2.service %{buildroot}/lib/systemd/system/serviceradar-goflow2.service
install -m 644 %{_sourcedir}/build/packaging/goflow2/config/goflow2.conf %{buildroot}/etc/serviceradar/goflow2.conf
