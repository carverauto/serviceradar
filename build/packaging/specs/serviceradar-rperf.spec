...
# Install the binary (assumes binary is built at /src/rust/rperf-server/target/release/serviceradar-rperf)
install -m 755 %{_builddir}/serviceradar-rperf %{buildroot}/usr/local/bin/

# Install systemd service from packaging directory
install -m 644 %{_sourcedir}/build/packaging/rperf/systemd/serviceradar-rperf.service %{buildroot}/lib/systemd/system/
