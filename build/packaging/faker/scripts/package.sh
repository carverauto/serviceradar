...
cp build/packaging/faker/config/faker.json "${PACKAGE_DIR}/usr/share/serviceradar/faker/config/"

# Copy systemd service file
cp build/packaging/faker/systemd/serviceradar-faker.service "${PACKAGE_DIR}/usr/share/serviceradar/faker/systemd/"

# Copy scripts
cp build/packaging/faker/scripts/postinstall.sh "${PACKAGE_DIR}/usr/share/serviceradar/faker/scripts/"
cp build/packaging/faker/scripts/preremove.sh "${PACKAGE_DIR}/usr/share/serviceradar/faker/scripts/"
...
if [ "${PACKAGE_TYPE}" = "rpm" ]; then
    ...
    rpmbuild -bb \
        ...
        build/packaging/specs/serviceradar-faker.spec
