# GENERATED PROJECTION: elixir/serviceradar_core/test/INTEGRATION_SOURCE_DISPOSITIONS.tsv is authoritative.
# //:ci_heavy_gate_contract_test enforces this projection exactly.
...
ASYNC_INTEGRATION_SRCS = [
    ...
    "test/serviceradar/inventory/device_identifier_gc_worker_test.exs",
    ...
    "test/serviceradar/inventory/identity/fence_test.exs",
    ...
    "test/serviceradar/inventory/identity_reconciler_mac_classification_test.exs",
    "test/serviceradar/inventory/identity_reconciler_merge_guard_test.exs",
    "test/serviceradar/inventory/identity_reconciler_merge_test.exs",
    ...
    "test/serviceradar/jobs/schedule_health_worker_test.exs",
    ...
    "test/serviceradar/observability/seasonal_disposition/edge_baseline_producer_test.exs",
    ...
    "test/serviceradar/plugins/anomaly_addon_profile_seeder_test.exs",
