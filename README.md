...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-agent_1.0.26.deb \
     ...
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-core_1.0.26.deb \
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-web_1.0.26.deb

# Install components as needed
sudo dpkg -i serviceradar-agent_1.0.26.deb serviceradar-poller_1.0.26.deb serviceradar-core_1.0.26.deb serviceradar-web_1.0.26.deb
```
