...
Demo site: [demo.serviceradar.cloud](https://demo.serviceradar.cloud). Sign in
with **Enterprise SSO** (Authentik). Local `demo@localhost` password login is
retired; keep a break-glass admin for IdP outages.
