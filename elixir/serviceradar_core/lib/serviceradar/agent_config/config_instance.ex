defmodule ServiceRadar.AgentConfig.ConfigInstance do
  ...
  alias ServiceRadar.AgentConfig.Changes.ComputeConfigHash
  alias ServiceRadar.AgentConfig.Changes.IncrementVersion
  ...
  actions do
    ...
    create :create do
      ...
      change ComputeConfigHash
      change IncrementVersion
    end
  ...
  attributes do
    ...
    ResourceAttributes.config_type_attribute("Type of configuration")
    ...
    ResourceAttributes.config_snapshot_attributes(
      compiled_config_description: "Compiled JSON configuration for agent consumption",
      content_hash_description: "SHA256 hash of compiled_config for change detection",
      source_ids_description: "IDs of source resources that contributed to this config"
    )
