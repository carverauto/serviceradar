defmodule ServiceRadar.AgentConfig.Compiler do
  ...
  Each config type (sweep, sysmon, snmp, mapper, visibility) implements this behaviour to compile
  ...
  @type config_type :: :sweep | :sysmon | :snmp | :mapper | :visibility
  ...
  @compilers %{
    ...
    visibility: ServiceRadar.AgentConfig.Compilers.VisibilityCompiler
  }
