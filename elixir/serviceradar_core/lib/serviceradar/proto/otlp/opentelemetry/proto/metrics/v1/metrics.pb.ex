...
defmodule Opentelemetry.Proto.Metrics.V1.HistogramDataPoint do
  ...
  field :bucket_counts, 6,
    repeated: true,
    type: :fixed64,
    json_name: "bucketCounts"

  field :explicit_bounds, 7,
    repeated: true,
    type: :double,
...
defmodule Opentelemetry.Proto.Metrics.V1.ExponentialHistogramDataPoint do
  ...
  alias Opentelemetry.Proto.Metrics.V1.ExponentialHistogramDataPoint.Buckets
  ...
  field :positive, 8, type: Buckets
  field :negative, 9, type: Buckets
  field :flags, 10, type: :uint32
