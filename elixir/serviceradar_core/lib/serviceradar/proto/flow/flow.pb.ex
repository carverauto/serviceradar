defmodule Flowpb.FlowMessage.FlowType do
  ...
  use Protobuf,
    enum: true,
    full_name: "flowpb.FlowMessage.FlowType",
...
defmodule Flowpb.FlowMessage.LayerStack do
  ...
  use Protobuf,
    enum: true,
    full_name: "flowpb.FlowMessage.LayerStack",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Flowpb.FlowAttribution do
  ...
  use Protobuf,
    full_name: "flowpb.FlowAttribution",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Flowpb.AttributedFlowMessage do
  ...
  use Protobuf,
    full_name: "flowpb.AttributedFlowMessage",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
