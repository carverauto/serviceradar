defmodule ServiceRadar.Dashboards.Checks.ActorCanEditDashboardInstance do
  @moduledoc """
  Filters package dashboard instances editable by the current actor.
  """
  ...
  @impl true
  def describe(_opts), do: "actor can edit package dashboard instance"
  ...
  def filter(%{id: actor_id}, _authorizer, _opts) when not is_nil(actor_id) do
    SubjectGrant.instance_edit(actor_id)
  end
