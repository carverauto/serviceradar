defmodule ServiceRadar.Inventory.Device do
  ...
  policies do
    ...
    policy action_type(:create) do
      authorize_if(
        {ServiceRadar.Policies.Checks.ActorHasPermission, permission: "devices.create"}
      )
    end
    ...
    policy action_type(:update) do
      authorize_if(
        {ServiceRadar.Policies.Checks.ActorHasPermission, permission: "devices.update"}
      )
    end
    ...
    policy action_type(:destroy) do
      authorize_if(
        {ServiceRadar.Policies.Checks.ActorHasPermission, permission: "devices.delete"}
      )
    end

    policy action(:bulk_soft_delete) do
      authorize_if(
        {ServiceRadar.Policies.Checks.ActorHasPermission, permission: "devices.bulk_delete"}
      )
    end
  end
