defmodule ServiceRadar.Identity.OAuthClient.Checks.CreatingOwnClient do
  @moduledoc """
  Custom policy check to verify a user is creating an OAuth client for themselves.
  ...
  def describe(_opts) do
    "actor is creating an OAuth client for themselves"
  end
