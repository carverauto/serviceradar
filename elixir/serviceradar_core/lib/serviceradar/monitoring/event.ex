defmodule ServiceRadar.Monitoring.Event do
  ...
  They can be generated by service checks, agents, gateways, or the
  system itself.
  ...
  - `:gateway` - Gateway status changes
  ...
  attributes do
    ...
    attribute :category, :atom do
      allow_nil? false
      public? true
      constraints one_of: [:check, :alert, :agent, :gateway, :device, :system, :audit]
    ...
    attribute :source_type, :atom do
      public? true
      constraints one_of: [:service_check, :alert, :agent, :gateway, :device, :user, :system]
    ...
    attribute :actor_type, :atom do
      public? true
      constraints one_of: [:user, :system, :agent, :gateway, :scheduler]
