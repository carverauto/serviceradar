defmodule ServiceRadar.PrefixTags.ThreatIntelMaterializeWorker do
  ...
  @default_reschedule_seconds 5 * 60
  @default_failure_reschedule_seconds 10 * 60
  ...
  defp do_perform do
    ...
    case ThreatIntelSource.reload() do
      ...
      {:error, reason} ->
        ...
        Logger.warning("Threat-intel tag materialize failed", reason: inspect(reason))
