defmodule ServiceRadar.Repo.Migrations.HardenAgeDeviceNeighborhoodSqlQuoting do
  @moduledoc """
  Replaces the AGE device neighborhood helper with a version that safely quotes
  dynamic Cypher text when calling `ag_catalog.cypher/2`.
  """
