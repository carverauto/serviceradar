defmodule ServiceRadar.Repo.Migrations.AddRemainingHighVolumeRetentionPolicies do
  @moduledoc """
  Adds retention policies for high-volume hypertables that were created outside
  the original observability retention migration.

  The migration is intentionally idempotent and skips tables that are absent,
  not hypertables, or running without TimescaleDB.
  """
  use Ecto.Migration
  ...
  def down do
    Enum.each(@retention_30_days, &remove_retention_policy/1)
  end
