defmodule ServiceRadar.Repo.Migrations.AddNgJobSchedules do
  @moduledoc """
  Creates the ng_job_schedules table for scheduling jobs.

  This table was originally in web-ng but is now managed by serviceradar_core.
  """
  use Ecto.Migration
