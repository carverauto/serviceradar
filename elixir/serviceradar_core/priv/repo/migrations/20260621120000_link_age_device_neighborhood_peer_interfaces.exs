defmodule ServiceRadar.Repo.Migrations.LinkAgeDeviceNeighborhoodPeerInterfaces do
  @moduledoc """
  Adds owning-device details to peer interface rows returned by the AGE device
  neighborhood helper.
  """
