defmodule ServiceRadar.Observability.OcsfEventsHypertableMigrationTest do
  use ExUnit.Case, async: true

  @migration_path "priv/repo/migrations/20260812201000_ensure_ocsf_events_hypertable.exs"

  test "repairs a bounded regular ocsf_events table before the hourly CAGG" do
    migration = File.read!(@migration_path)

    assert migration =~ ~s(@table "platform.ocsf_events")
    ...
    assert migration =~
             ~s{System.get_env("SERVICERADAR_OCSF_EVENTS_CHUNK_INTERVAL_HOURS", "6")}
  end
