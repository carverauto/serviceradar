defmodule ServiceRadar.Plugins.PolicyOwnedAssignmentRecoveryTest do
  ...
  test "a committed policy recovery pushes the exact postflight principal after terminal persistence" do
    test_pid = self()
    ...
    assert {:ok, :reconciled} =
             Executor.execute("recovery-request-1",
               ...
               test_finisher: fn ^request,
                 ...
                 # while the terminal status write is still in progress.
