...
copy_dir "$ROOT/addons/otel-collector" "$WORKDIR/addons/otel-collector"
copy_dir "$ROOT/addons/scalibr-endpoint-inventory" "$WORKDIR/addons/scalibr-endpoint-inventory"
