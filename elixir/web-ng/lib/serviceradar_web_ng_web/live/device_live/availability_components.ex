defmodule ServiceRadarWebNGWeb.DeviceLive.AvailabilityComponents do
  ...
  defp availability_color(:online), do: "bg-[var(--color-success)]"
  defp availability_color(:offline), do: "bg-[var(--color-error)]"
