defmodule ServiceRadarWebNGWeb.Settings.VisibilityProfilesLive.TargetBuilder do
  ...
  alias ServiceRadarWebNGWeb.Settings.VisibilityProfilesLive.FormState
  ...
  def update_builder(builder, params) do
    builder
    |> Map.merge(FormState.stringify_params(params))
  ...
  defp normalize_filters_list(filters_by_index, config) when is_map(filters_by_index) do
    filters_by_index
    |> Enum.sort_by(fn {key, _value} -> FormState.parse_int(key, 0) end)
