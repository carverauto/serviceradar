...
config :serviceradar_web_ng,
       ...
       to_int.(
         System.get_env("SERVICERADAR_MANAGED_DEVICE_LIMIT") ||
           System.get_env("SERVICERADAR_MAX_DEVICES")
       )
...
if plugin_storage_overrides != [] do
  ...
  core_plugin_storage_config =
    Keyword.merge(plugin_storage_defaults, core_plugin_storage_overrides)
