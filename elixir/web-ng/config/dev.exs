...
asset_watchers =
  case "SERVICERADAR_WEB_NG_ASSET_WATCHERS" |> System.get_env("true") |> String.downcase() do
    "false" ->
      []
...
code_reloader? =
  case "SERVICERADAR_WEB_NG_CODE_RELOADER" |> System.get_env("true") |> String.downcase() do
    "false" -> false
    "0" -> false
    "no" -> false
    _ -> true
...
live_reload? =
  case "SERVICERADAR_WEB_NG_LIVE_RELOAD" |> System.get_env("true") |> String.downcase() do
    "false" -> false
    "0" -> false
    "no" -> false
    _ -> true
  ...
  config :serviceradar_web_ng, ServiceRadarWebNGWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/serviceradar_web_ng_web/router\.ex$",
        ~r"lib/serviceradar_web_ng_web/(controllers|live|components)/.*\.(ex|heex)$"
      ]
    ]
else
  config :serviceradar_web_ng, ServiceRadarWebNGWeb.Endpoint, live_reload: []
end
