    ...
    children =
      [
        ...
        [
          ...
          {DynamicSupervisor,
           strategy: :one_for_one, name: ServiceRadarCoreElx.CameraRelay.BoomboxSidecarSupervisor},
          ServiceRadarCoreElx.CameraRelay.BoomboxSidecarManager,
          {DynamicSupervisor,
           strategy: :one_for_one,
           name: ServiceRadarCoreElx.CameraRelay.AnalysisDispatchSupervisor},
          ...
          {Registry,
           keys: :unique, name: ServiceRadarCoreElx.RemoteDesktop.DataChannelProvider.Registry},
          {DynamicSupervisor,
           strategy: :one_for_one,
           name: ServiceRadarCoreElx.RemoteDesktop.DataChannelProvider.Supervisor},
