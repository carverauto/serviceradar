...
FROM base;
WITH base AS (
    SELECT date_trunc('hour', NOW()) AS hour_now
)
...
SELECT base.hour_now - INTERVAL '1 hour',
    'device-alpha',
    'sysmon.cpu',
    'cpu.usage_percent',
    95.0,
...
FROM base
UNION ALL
SELECT base.hour_now - INTERVAL '7 days 1 hour',
    'device-alpha',
    'sysmon.cpu',
    'cpu.usage_percent',
    10.0,
...
FROM base
UNION ALL
SELECT base.hour_now - INTERVAL '14 days 1 hour',
    'device-alpha',
    'sysmon.cpu',
    'cpu.usage_percent',
    12.0,
