...
# Remove hardcoded IPs and rely on Docker DNS resolution
generate_cert "core" "core.serviceradar" "DNS:core,DNS:core.serviceradar,DNS:serviceradar-core,DNS:localhost,IP:127.0.0.1"
generate_cert "proton" "proton.serviceradar" "DNS:proton,DNS:proton.serviceradar,DNS:serviceradar-proton,DNS:localhost,IP:127.0.0.1"
generate_cert "nats" "nats.serviceradar" "DNS:nats,DNS:nats.serviceradar,DNS:serviceradar-nats,DNS:localhost,IP:127.0.0.1"
generate_cert "kv" "kv.serviceradar" "DNS:kv,DNS:kv.serviceradar,DNS:serviceradar-kv,DNS:localhost,IP:127.0.0.1"
...
generate_cert "mapper" "mapper.serviceradar" "DNS:mapper,DNS:mapper.serviceradar,DNS:serviceradar-mapper,DNS:localhost,IP:127.0.0.1"
generate_cert "snmp-checker" "snmp-checker.serviceradar" "DNS:snmp-checker,DNS:snmp-checker.serviceradar,DNS:serviceradar-snmp-checker,DNS:localhost,IP:127.0.0.1"
generate_cert "rperf-client" "rperf-client.serviceradar" "DNS:rperf-client,DNS:rperf-client.serviceradar,DNS:serviceradar-rperf-client,DNS:localhost,IP:127.0.0.1"
generate_cert "sync" "sync.serviceradar" "DNS:sync,DNS:sync.serviceradar,DNS:serviceradar-sync,DNS:localhost,IP:127.0.0.1"
...
generate_cert "trapd" "trapd.serviceradar" "DNS:trapd,DNS:trapd.serviceradar,DNS:serviceradar-trapd,DNS:localhost,IP:127.0.0.1"
generate_cert "zen" "zen.serviceradar" "DNS:zen,DNS:zen.serviceradar,DNS:serviceradar-zen,DNS:localhost,IP:127.0.0.1"
