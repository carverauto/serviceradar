...
- `cnpg-cluster.yaml` – CNPG `Cluster` spec that enables TimescaleDB + AGE using `registry.carverauto.dev/serviceradar/serviceradar-cnpg:18.3.0-sr2-a78b3afd` (matches `docker-compose.yml`).
