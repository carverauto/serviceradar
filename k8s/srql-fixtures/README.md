...
- `cnpg-cluster.yaml` – CNPG `Cluster` spec that enables TimescaleDB + AGE using `registry.carverauto.dev/serviceradar/serviceradar-cnpg:18.3.0-sr2@sha256:db1dee5a7f8f52f627d7dfecbce7754977c8f7294f007825294fd5359402fff5` (matches `docker-compose.yml`).
