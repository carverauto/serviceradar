...
type StatusResponse struct {
	...
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // JSON data (e.g., MetricSample)
...
type MetricSample struct {
	...
	Cpus          []*MetricSample_Cpu    `protobuf:"bytes,3,rep,name=cpus,proto3" json:"cpus,omitempty"`
	Disks         []*MetricSample_Disk   `protobuf:"bytes,4,rep,name=disks,proto3" json:"disks,omitempty"`
	Memory        *MetricSample_Memory   `protobuf:"bytes,5,opt,name=memory,proto3" json:"memory,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetricSample) GetHostId() string {
	if x != nil {
		return x.HostId
	}
	return ""
...
func (x *MetricSample) GetCpus() []*MetricSample_Cpu {
	if x != nil {
		return x.Cpus
	}
	return nil
...
func (x *MetricSample) GetDisks() []*MetricSample_Disk {
	if x != nil {
		return x.Disks
	}
	return nil
...
func (x *MetricSample) GetMemory() *MetricSample_Memory {
	if x != nil {
		return x.Memory
	}
	return nil
...
type SweepServiceStatus struct {
	...
	AvailableHosts int32                  `protobuf:"varint,3,opt,name=available_hosts,json=availableHosts,proto3" json:"available_hosts,omitempty"`
	Ports          []*PortStatus          `protobuf:"bytes,4,rep,name=ports,proto3" json:"ports,omitempty"`
	LastSweep      int64                  `protobuf:"varint,5,opt,name=last_sweep,json=lastSweep,proto3" json:"last_sweep,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MetricSample_Cpu) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetricSample_Cpu) ProtoMessage() {}

func (x *MetricSample_Cpu) ProtoReflect() protoreflect.Message {
	mi := &file_monitoring_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MetricSample_Cpu.ProtoReflect.Descriptor instead.
func (*MetricSample_Cpu) Descriptor() ([]byte, []int) {
	return file_monitoring_proto_rawDescGZIP(), []int{2, 0}
}

func (x *MetricSample_Cpu) GetCoreId() int32 {
	if x != nil {
		return x.CoreId
	}
	return 0
...
func (x *MetricSample_Cpu) GetUsagePercent() float32 {
	if x != nil {
...
func (x *MetricSample_Disk) Reset() {
	*x = MetricSample_Disk{}
...
func (x *MetricSample_Disk) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetricSample_Disk) ProtoMessage() {}

func (x *MetricSample_Disk) ProtoReflect() protoreflect.Message {
	mi := &file_monitoring_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MetricSample_Disk.ProtoReflect.Descriptor instead.
func (*MetricSample_Disk) Descriptor() ([]byte, []int) {
	return file_monitoring_proto_rawDescGZIP(), []int{2, 1}
}

func (x *MetricSample_Disk) GetMountPoint() string {
	if x != nil {
		return x.MountPoint
	}
	return ""
...
func (x *MetricSample_Disk) GetUsedBytes() uint64 {
	if x != nil {
		return x.UsedBytes
	}
	return 0
...
func (x *MetricSample_Disk) GetTotalBytes() uint64 {
	if x != nil {
		return x.TotalBytes
	}
	return 0
...
type MetricSample_Memory struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MetricSample_Memory) Reset() {
	*x = MetricSample_Memory{}
	mi := &file_monitoring_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MetricSample_Memory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetricSample_Memory) ProtoMessage() {}

func (x *MetricSample_Memory) ProtoReflect() protoreflect.Message {
	mi := &file_monitoring_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MetricSample_Memory.ProtoReflect.Descriptor instead.
func (*MetricSample_Memory) Descriptor() ([]byte, []int) {
	return file_monitoring_proto_rawDescGZIP(), []int{2, 2}
}

func (x *MetricSample_Memory) GetUsedBytes() uint64 {
	if x != nil {
		return x.UsedBytes
	}
	return 0
...
func (x *MetricSample_Memory) GetTotalBytes() uint64 {
	if x != nil {
		return x.TotalBytes
	}
	return 0
...
var file_monitoring_proto_rawDesc = string([]byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x22, 0x83,
	...
	0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c,
	...
	0x70, 0x6f, 0x72, 0x74, 0x22, 0xb3, 0x01, 0x0a, 0x0e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	,
	...
	0x1a, 0x48, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x75, 0x73,
	0x65, 0x64, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0x87, 0x01, 0x0a, 0x13, 0x50,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e,
	0x67, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6f, 0x6c,
	0x6c, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x6f,
	0x6c, 0x6c, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73,
	0x74, 0x61, 0x6d, 0x70, 0x22, 0x32, 0x0a, 0x14, 0x50, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x53, 0x74,
	...
	0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x22, 0xb2, 0x01, 0x0a, 0x0d, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65,
	...
	0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xc5, 0x01,
	0x0a, 0x12, 0x53, 0x77, 0x65, 0x65, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x74,
	...
	,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x64, 0x0a, 0x0d, 0x50,
	0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x53, 0x0a, 0x0c,
	0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1f, 0x2e, 0x6d,
	0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x50, 0x6f, 0x6c, 0x6c, 0x65, 0x72,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e,
	0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x50, 0x6f, 0x6c, 0x6c, 0x65,
	...
	0x63, 0x61, 0x72, 0x76, 0x65, 0x72, 0x61, 0x75, 0x74, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x72, 0x61, 0x64, 0x61, 0x72, 0x2f, 0x63, 0x6d, 0x64, 0x2f, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x65, 0x72, 0x73, 0x2f, 0x73, 0x79, 0x73, 0x6d, 0x6f, 0x6e, 0x2f, 0x73, 0x72, 0x63, 0x2f,
...
var file_monitoring_proto_goTypes = []any{
	...
	(*MetricSample)(nil),         // 2: monitoring.MetricSample
	(*PollerStatusRequest)(nil),  // 3: monitoring.PollerStatusRequest
	(*PollerStatusResponse)(nil), // 4: monitoring.PollerStatusResponse
	...
	(*MetricSample_Cpu)(nil),     // 8: monitoring.MetricSample.Cpu
	(*MetricSample_Disk)(nil),    // 9: monitoring.MetricSample.Disk
	(*MetricSample_Memory)(nil),  // 10: monitoring.MetricSample.Memory
}
var file_monitoring_proto_depIdxs = []int32{
	8,  // 0: monitoring.MetricSample.cpus:type_name -> monitoring.MetricSample.Cpu
	9,  // 1: monitoring.MetricSample.disks:type_name -> monitoring.MetricSample.Disk
	10, // 2: monitoring.MetricSample.memory:type_name -> monitoring.MetricSample.Memory
	5,  // 3: monitoring.PollerStatusRequest.services:type_name -> monitoring.ServiceStatus
	7,  // 4: monitoring.SweepServiceStatus.ports:type_name -> monitoring.PortStatus
	0,  // 5: monitoring.AgentService.GetStatus:input_type -> monitoring.StatusRequest
	3,  // 6: monitoring.PollerService.ReportStatus:input_type -> monitoring.PollerStatusRequest
	1,  // 7: monitoring.AgentService.GetStatus:output_type -> monitoring.StatusResponse
	4,  // 8: monitoring.PollerService.ReportStatus:output_type -> monitoring.PollerStatusResponse
