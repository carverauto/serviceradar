  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'doc', id: 'sso-oidc-setup', label: 'OIDC SSO Setup'},
        {type: 'doc', id: 'sso-saml-setup', label: 'SAML SSO Setup'},
        {type: 'doc', id: 'sso-gateway-setup', label: 'Gateway Authentication'},
        {type: 'doc', id: 'api-credentials', label: 'API Credentials'},
        {type: 'doc', id: 'sso-troubleshooting', label: 'SSO Troubleshooting'},
