...
Step-by-step operational procedures extracted from the repo-root `AGENTS.md`,
which must stay under a 40k-character context budget. `AGENTS.md` keeps the
rules and the build/test entry points; this file keeps the long command
sequences. This page is intentionally NOT part of the published Docusaurus
