...
1. **Agent**: Runs on your monitored hosts, collecting and streaming results via gRPC.
2. **Agent-Gateway**: Receives agent streams and forwards them to the core control plane.
3. **Core Service (core-elx)**: Processes data, powers the API, and triggers alerts.
4. **Web UI (web-ng)**: Delivers a sleek, modern dashboard for visualizing your infrastructure.
