...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-agent_1.0.33.deb \
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-poller_1.0.33.deb

sudo dpkg -i serviceradar-agent_1.0.33.deb serviceradar-poller_1.0.33.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-core_1.0.33.deb
sudo dpkg -i serviceradar-core_1.0.33.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-web_1.0.33.deb
sudo dpkg -i serviceradar-web_1.0.33.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-nats_1.0.33.deb
sudo dpkg -i serviceradar-nats_1.0.33.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-kv_1.0.33.deb
sudo dpkg -i serviceradar-kv_1.0.33.deb
```
...
```bash
# Debian/Ubuntu
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.33/serviceradar-rperf_1.0.33.deb
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.33/serviceradar-rperf-checker_1.0.33.deb
sudo dpkg -i serviceradar-rperf_1.0.33.deb serviceradar-rperf-checker_1.0.33.deb

# RHEL/Oracle Linux
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.33/serviceradar-rperf-1.0.33.el9.x86_64.rpm
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.33/serviceradar-rperf-checker-1.0.33.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-rperf-1.0.33.el9.x86_64.rpm ./serviceradar-rperf-checker-1.0.33.el9.x86_64.rpm
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-dusk-checker_1.0.33.deb
sudo dpkg -i serviceradar-dusk-checker_1.0.33.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-agent_1.0.33.deb
sudo dpkg -i serviceradar-agent_1.0.33.deb
```

2. **On monitoring host** (install the poller):

```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-poller_1.0.33.deb
sudo dpkg -i serviceradar-poller_1.0.33.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-core-1.0.33-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-web-1.0.33-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-agent-1.0.33-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-poller-1.0.33-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-core-1.0.33-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-web-1.0.33-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-agent-1.0.33-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-poller-1.0.33-1.el9.x86_64.rpm
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-nats-1.0.33-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-nats-1.0.33-1.el9.x86_64.rpm
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-kv-1.0.33-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-kv-1.0.33-1.el9.x86_64.rpm
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-snmp-checker-1.0.33-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-snmp-checker-1.0.33-1.el9.x86_64.rpm

# Dusk Node Checker for Dusk Network monitoring
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.33/serviceradar-dusk-checker-1.0.33-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-dusk-checker-1.0.33-1.el9.x86_64.rpm
```
