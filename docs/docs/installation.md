...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-agent_1.0.37.deb \
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-poller_1.0.37.deb

sudo dpkg -i serviceradar-agent_1.0.37.deb serviceradar-poller_1.0.37.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-core_1.0.37.deb
sudo dpkg -i serviceradar-core_1.0.37.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-web_1.0.37.deb
sudo dpkg -i serviceradar-web_1.0.37.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-nats_1.0.37.deb
sudo dpkg -i serviceradar-nats_1.0.37.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-kv_1.0.37.deb
sudo dpkg -i serviceradar-kv_1.0.37.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-snmp-checker_1.0.37.deb
sudo dpkg -i serviceradar-snmp-checker_1.0.37.deb
```
...
```bash
# Debian/Ubuntu
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.37/serviceradar-rperf_1.0.37.deb
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.37/serviceradar-rperf-checker_1.0.37.deb
sudo dpkg -i serviceradar-rperf_1.0.37.deb serviceradar-rperf-checker_1.0.37.deb

# RHEL/Oracle Linux
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.37/serviceradar-rperf-1.0.37.el9.x86_64.rpm
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.37/serviceradar-rperf-checker-1.0.37.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-rperf-1.0.37.el9.x86_64.rpm ./serviceradar-rperf-checker-1.0.37.el9.x86_64.rpm
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-dusk-checker_1.0.37.deb
sudo dpkg -i serviceradar-dusk-checker_1.0.37.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-agent_1.0.37.deb
sudo dpkg -i serviceradar-agent_1.0.37.deb
```

2. **On monitoring host** (install the poller):

```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-poller_1.0.37.deb
sudo dpkg -i serviceradar-poller_1.0.37.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-core-1.0.37-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-web-1.0.37-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-agent-1.0.37-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-poller-1.0.37-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-core-1.0.37-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-web-1.0.37-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-agent-1.0.37-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-poller-1.0.37-1.el9.x86_64.rpm
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-nats-1.0.37-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-nats-1.0.37-1.el9.x86_64.rpm
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-kv-1.0.37-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-kv-1.0.37-1.el9.x86_64.rpm
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-snmp-checker-1.0.37-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-snmp-checker-1.0.37-1.el9.x86_64.rpm

# Dusk Node Checker for Dusk Network monitoring
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-dusk-checker-1.0.37-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-dusk-checker-1.0.37-1.el9.x86_64.rpm
```
