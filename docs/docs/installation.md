...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-agent_1.0.26.deb \
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-poller_1.0.26.deb

sudo dpkg -i serviceradar-agent_1.0.26.deb serviceradar-poller_1.0.26.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-core_1.0.26.deb
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-web_1.0.26.deb
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-snmp-checker_1.0.26.deb
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-dusk-checker_1.0.26.deb
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-poller_1.0.26.deb
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-core-1.0.26-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-web-1.0.26-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-agent-1.0.26-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.26/serviceradar-poller-1.0.26-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-core-1.0.26-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-web-1.0.26-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-agent-1.0.26-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-poller-1.0.26-1.el9.x86_64.rpm
```
