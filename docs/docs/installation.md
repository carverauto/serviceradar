...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-agent_1.0.28.deb \
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-poller_1.0.28.deb

sudo dpkg -i serviceradar-agent_1.0.28.deb serviceradar-poller_1.0.28.deb
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-core_1.0.28.deb
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-web_1.0.28.deb
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-nats_1.0.28.deb
sudo dpkg -i serviceradar-nats_1.0.28.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-kv_1.0.28.deb
sudo dpkg -i serviceradar-kv_1.0.28.deb
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-snmp-checker_1.0.28.deb
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-dusk-checker_1.0.28.deb
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-poller_1.0.28.deb
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-core-1.0.28-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-web-1.0.28-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-agent-1.0.28-1.el9.x86_64.rpm
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-poller-1.0.28-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-core-1.0.28-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-web-1.0.28-1.el9.x86_64.rpm
```
...
```bash
sudo dnf install -y ./serviceradar-agent-1.0.28-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-poller-1.0.28-1.el9.x86_64.rpm
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-nats-1.0.28-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-nats-1.0.28-1.el9.x86_64.rpm
```
...
```bash
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-kv-1.0.28-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-kv-1.0.28-1.el9.x86_64.rpm
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-snmp-checker-1.0.28-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-snmp-checker-1.0.28-1.el9.x86_64.rpm

# Dusk Node Checker for Dusk Network monitoring
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.28/serviceradar-dusk-checker-1.0.28-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-dusk-checker-1.0.28-1.el9.x86_64.rpm
```
