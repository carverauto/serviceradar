...
```bash
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.30/serviceradar-rperf_1.0.30_amd64.deb
sudo dpkg -i serviceradar-rperf_1.0.30_amd64.deb
```
...
```bash
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.30/serviceradar-rperf-checker-1.0.30.amd64.deb
sudo dpkg -i serviceradar-rperf-checker-1.0.30.amd64.deb
```
...
```bash
curl -LO https://github.com/mfreeman451/rperf/releases/download/v1.0.30/serviceradar-rperf-1.0.30-1.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-rperf-1.0.30-1.el9.x86_64.rpm
```
...
```bash
curl -LO https://github.com/mfreeman451/rperf/releases/download/v0.1.0/serviceradar-rperf-checker-1.0.30.el9.x86_64.rpm
sudo dnf install -y ./serviceradar-rperf-checker-1.0.30.el9.x86_64.rpm
```
