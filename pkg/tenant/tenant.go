...
// Example: "events.ocsf.processed" -> "acme-corp.events.ocsf.processed"
...
// Example: PrefixChannelWithSlug("acme-corp", "events.ocsf.processed") -> "acme-corp.events.ocsf.processed"
