...
// Source: github.com/carverauto/serviceradar/pkg/sync (interfaces: GRPCClient,Integration,SRQLQuerier)
//
// Generated by this command:
//
//	mockgen -destination=mock_sync.go -package=sync github.com/carverauto/serviceradar/pkg/sync GRPCClient,Integration,SRQLQuerier
//
...
func (m *MockIntegration) Fetch(ctx context.Context) ([]*models.DeviceUpdate, error) {
	m.ctrl.T.Helper()
