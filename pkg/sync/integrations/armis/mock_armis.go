...
// Source: github.com/carverauto/serviceradar/pkg/sync/integrations/armis (interfaces: HTTPClient,TokenProvider,DeviceFetcher,KVWriter,SRQLQuerier,ArmisUpdater,ResultSubmitter)
//
// Generated by this command:
//
//	mockgen -destination=mock_armis.go -package=armis github.com/carverauto/serviceradar/pkg/sync/integrations/armis HTTPClient,TokenProvider,DeviceFetcher,KVWriter,SRQLQuerier,ArmisUpdater,ResultSubmitter
//
...
// UpdateMultipleDeviceCustomAttributes mocks base method.
func (m *MockArmisUpdater) UpdateMultipleDeviceCustomAttributes(ctx context.Context, updates []DeviceAttributeUpdate) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateMultipleDeviceCustomAttributes", ctx, updates)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateMultipleDeviceCustomAttributes indicates an expected call of UpdateMultipleDeviceCustomAttributes.
func (mr *MockArmisUpdaterMockRecorder) UpdateMultipleDeviceCustomAttributes(ctx, updates any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateMultipleDeviceCustomAttributes", reflect.TypeOf((*MockArmisUpdater)(nil).UpdateMultipleDeviceCustomAttributes), ctx, updates)
}
