-- Recreate device metrics CAGGs to fix stale function OID references.
-- Resolves: "cache lookup failed for function 'time_bucket' with 2 args" error
...
-- Recreate CPU rollup with fresh function bindings
...
-- Recreate composite view joining the CAGGs
