...
-- FIXED: Corrected discovery_sources array aggregation logic
-- The previous logic was backwards - it was NOT adding new discovery sources
-- when they weren't already in the array, which prevented proper aggregation
