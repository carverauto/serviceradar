...
// PublishDiscoveredInterface stores a single discovered interface observation.
...
// PublishBatchDiscoveredInterfaces stores multiple discovered interface observations.
