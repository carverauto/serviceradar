...
//
//	mockgen -destination=pkg/db/mock_db.go -package=db github.com/carverauto/serviceradar/pkg/db Service
//
...
func (m *MockService) CleanupStaleUnifiedDevices(ctx context.Context, retention time.Duration) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanupStaleUnifiedDevices", ctx, retention)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) CleanupStaleUnifiedDevices(ctx, retention any) *gomock.Call {
...
func (m *MockService) CountUnifiedDevices(ctx context.Context) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountUnifiedDevices", ctx)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) CountUnifiedDevices(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountUnifiedDevices", reflect.TypeOf((*MockService)(nil).CountUnifiedDevices), ctx)
}
...
func (m *MockService) ListAgentsByPoller(ctx context.Context, pollerID string) ([]AgentInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAgentsByPoller", ctx, pollerID)
...
func (mr *MockServiceMockRecorder) ListAgentsByPoller(ctx, pollerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAgentsByPoller", reflect.TypeOf((*MockService)(nil).ListAgentsByPoller), ctx, pollerID)
}

// ListAgentsWithPollers mocks base method.
func (m *MockService) ListAgentsWithPollers(ctx context.Context) ([]AgentInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAgentsWithPollers", ctx)
	ret0, _ := ret[0].([]AgentInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) ListAgentsWithPollers(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAgentsWithPollers", reflect.TypeOf((*MockService)(nil).ListAgentsWithPollers), ctx)
}
...
func (m *MockService) StoreSysmonMetrics(ctx context.Context, pollerID, agentID, hostID, partition, hostIP, deviceID string, metrics *models.SysmonMetrics, timestamp time.Time) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StoreSysmonMetrics", ctx, pollerID, agentID, hostID, partition, hostIP, deviceID, metrics, timestamp)
	ret0, _ := ret[0].(error)
	return ret0
}

// StoreSysmonMetrics indicates an expected call of StoreSysmonMetrics.
func (mr *MockServiceMockRecorder) StoreSysmonMetrics(ctx, pollerID, agentID, hostID, partition, hostIP, deviceID, metrics, timestamp any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StoreSysmonMetrics", reflect.TypeOf((*MockService)(nil).StoreSysmonMetrics), ctx, pollerID, agentID, hostID, partition, hostIP, deviceID, metrics, timestamp)
}
