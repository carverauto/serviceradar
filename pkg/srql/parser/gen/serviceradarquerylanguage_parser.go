...
func serviceradarquerylanguageParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		0, 5, 1, 0, 18, 22, 1, 0, 10, 11, 1, 0, 23, 29, 1, 0, 8, 9, 2, 0, 30, 30,
		38, 43, 162, 0, 33, 1, 0, 0, 0, 2, 35, 1, 0, 0, 0, 4, 50, 1, 0, 0, 0, 6,
		...
		47, 5, 7, 0, 0, 47, 49, 5, 38, 0, 0, 48, 46, 1, 0, 0, 0, 48, 49, 1, 0,
		...
		61, 62, 5, 7, 0, 0, 62, 64, 5, 38, 0, 0, 63, 61, 1, 0, 0, 0, 63, 64, 1,
		...
		87, 3, 22, 11, 0, 87, 88, 5, 12, 0, 0, 88, 89, 5, 33, 0, 0, 89, 90, 3,
		14, 7, 0, 90, 91, 5, 34, 0, 0, 91, 111, 1, 0, 0, 0, 92, 93, 3, 22, 11,
		0, 93, 94, 5, 14, 0, 0, 94, 95, 5, 40, 0, 0, 95, 111, 1, 0, 0, 0, 96, 97,
		5, 33, 0, 0, 97, 98, 3, 10, 5, 0, 98, 99, 5, 34, 0, 0, 99, 111, 1, 0, 0,
		...
		0, 0, 111, 13, 1, 0, 0, 0, 112, 117, 3, 28, 14, 0, 113, 114, 5, 32, 0,
		...
		21, 1, 0, 0, 0, 129, 141, 5, 37, 0, 0, 130, 131, 3, 8, 4, 0, 131, 132,
		5, 31, 0, 0, 132, 133, 5, 37, 0, 0, 133, 141, 1, 0, 0, 0, 134, 135, 3,
		8, 4, 0, 135, 136, 5, 31, 0, 0, 136, 137, 5, 37, 0, 0, 137, 138, 5, 31,
		0, 0, 138, 139, 5, 37, 0, 0, 139, 141, 1, 0, 0, 0, 140, 129, 1, 0, 0, 0,
		140, 130, 1, 0, 0, 0, 140, 134, 1, 0, 0, 0, 141, 23, 1, 0, 0, 0, 142, 147,
		3, 26, 13, 0, 143, 144, 5, 32, 0, 0, 144, 146, 3, 26, 13, 0, 145, 143,
...
const (
	...
	ServiceRadarQueryLanguageParserEQ          = 23
	ServiceRadarQueryLanguageParserNEQ         = 24
	ServiceRadarQueryLanguageParserGT          = 25
	ServiceRadarQueryLanguageParserGTE         = 26
	ServiceRadarQueryLanguageParserLT          = 27
	ServiceRadarQueryLanguageParserLTE         = 28
	ServiceRadarQueryLanguageParserLIKE        = 29
	ServiceRadarQueryLanguageParserBOOLEAN     = 30
	ServiceRadarQueryLanguageParserDOT         = 31
	ServiceRadarQueryLanguageParserCOMMA       = 32
	ServiceRadarQueryLanguageParserLPAREN      = 33
	ServiceRadarQueryLanguageParserRPAREN      = 34
	ServiceRadarQueryLanguageParserAPOSTROPHE  = 35
	ServiceRadarQueryLanguageParserQUOTE       = 36
	ServiceRadarQueryLanguageParserID          = 37
	ServiceRadarQueryLanguageParserINTEGER     = 38
	ServiceRadarQueryLanguageParserFLOAT       = 39
	ServiceRadarQueryLanguageParserSTRING      = 40
	ServiceRadarQueryLanguageParserTIMESTAMP   = 41
	ServiceRadarQueryLanguageParserIPADDRESS   = 42
	ServiceRadarQueryLanguageParserMACADDRESS  = 43
	ServiceRadarQueryLanguageParserWS          = 44
)
...
func (p *ServiceRadarQueryLanguageParser) ComparisonOperator() (localctx IComparisonOperatorContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&1065353216) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *ServiceRadarQueryLanguageParser) Value() (localctx IValueContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&17318381879296) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
