...
func serviceradarquerylanguageParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 92, 415, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		60, 62, 64, 66, 68, 70, 72, 74, 76, 78, 0, 9, 1, 0, 49, 50, 1, 0, 81, 84,
		1, 0, 63, 65, 1, 0, 23, 27, 1, 0, 28, 45, 1, 0, 12, 13, 1, 0, 66, 72, 1,
		0, 10, 11, 3, 0, 20, 21, 73, 73, 86, 91, 435, 0, 84, 1, 0, 0, 0, 2, 86,
		...
		28, 0, 88, 89, 3, 16, 8, 0, 89, 90, 5, 47, 0, 0, 90, 91, 3, 56, 28, 0,
		...
		109, 5, 86, 0, 0, 108, 106, 1, 0, 0, 0, 108, 109, 1, 0, 0, 0, 109, 111,
		...
		130, 5, 86, 0, 0, 129, 127, 1, 0, 0, 0, 129, 130, 1, 0, 0, 0, 130, 132,
		...
		1, 0, 0, 0, 141, 142, 1, 0, 0, 0, 142, 7, 1, 0, 0, 0, 143, 145, 5, 46,
		0, 0, 144, 146, 3, 10, 5, 0, 145, 144, 1, 0, 0, 0, 145, 146, 1, 0, 0, 0,
		146, 147, 1, 0, 0, 0, 147, 148, 5, 47, 0, 0, 148, 152, 3, 20, 10, 0, 149,
		...
		175, 5, 75, 0, 0, 175, 177, 3, 12, 6, 0, 176, 174, 1, 0, 0, 0, 177, 180,
		1, 0, 0, 0, 178, 176, 1, 0, 0, 0, 178, 179, 1, 0, 0, 0, 179, 183, 1, 0,
		0, 0, 180, 178, 1, 0, 0, 0, 181, 183, 5, 80, 0, 0, 182, 173, 1, 0, 0, 0,
		182, 181, 1, 0, 0, 0, 183, 11, 1, 0, 0, 0, 184, 187, 3, 14, 7, 0, 185,
		186, 5, 62, 0, 0, 186, 188, 5, 85, 0, 0, 187, 185, 1, 0, 0, 0, 187, 188,
		1, 0, 0, 0, 188, 13, 1, 0, 0, 0, 189, 193, 3, 72, 36, 0, 190, 193, 3, 16,
		8, 0, 191, 193, 3, 78, 39, 0, 192, 189, 1, 0, 0, 0, 192, 190, 1, 0, 0,
		0, 192, 191, 1, 0, 0, 0, 193, 15, 1, 0, 0, 0, 194, 195, 5, 85, 0, 0, 195,
		198, 5, 76, 0, 0, 196, 199, 3, 18, 9, 0, 197, 199, 5, 80, 0, 0, 198, 196,
		1, 0, 0, 0, 198, 197, 1, 0, 0, 0, 198, 199, 1, 0, 0, 0, 199, 200, 1, 0,
		0, 0, 200, 201, 5, 77, 0, 0, 201, 17, 1, 0, 0, 0, 202, 207, 3, 14, 7, 0,
		203, 204, 5, 75, 0, 0, 204, 206, 3, 14, 7, 0, 205, 203, 1, 0, 0, 0, 206,
		209, 1, 0, 0, 0, 207, 205, 1, 0, 0, 0, 207, 208, 1, 0, 0, 0, 208, 19, 1,
		0, 0, 0, 209, 207, 1, 0, 0, 0, 210, 213, 3, 22, 11, 0, 211, 212, 5, 62,
		0, 0, 212, 214, 5, 85, 0, 0, 213, 211, 1, 0, 0, 0, 213, 214, 1, 0, 0, 0,
		214, 21, 1, 0, 0, 0, 215, 218, 3, 56, 28, 0, 216, 218, 5, 85, 0, 0, 217,
		215, 1, 0, 0, 0, 217, 216, 1, 0, 0, 0, 218, 243, 1, 0, 0, 0, 219, 220,
		5, 48, 0, 0, 220, 223, 5, 76, 0, 0, 221, 224, 3, 56, 28, 0, 222, 224, 5,
		85, 0, 0, 223, 221, 1, 0, 0, 0, 223, 222, 1, 0, 0, 0, 224, 225, 1, 0, 0,
		0, 225, 243, 5, 77, 0, 0, 226, 227, 3, 24, 12, 0, 227, 230, 5, 76, 0, 0,
		228, 231, 3, 56, 28, 0, 229, 231, 5, 85, 0, 0, 230, 228, 1, 0, 0, 0, 230,
		229, 1, 0, 0, 0, 231, 232, 1, 0, 0, 0, 232, 233, 5, 75, 0, 0, 233, 234,
		3, 72, 36, 0, 234, 235, 5, 75, 0, 0, 235, 238, 3, 26, 13, 0, 236, 237,
		5, 75, 0, 0, 237, 239, 3, 26, 13, 0, 238, 236, 1, 0, 0, 0, 238, 239, 1,
		0, 0, 0, 239, 240, 1, 0, 0, 0, 240, 241, 5, 77, 0, 0, 241, 243, 1, 0, 0,
		...
		0, 0, 249, 27, 1, 0, 0, 0, 250, 251, 5, 86, 0, 0, 251, 252, 7, 1, 0, 0,
		252, 29, 1, 0, 0, 0, 253, 255, 3, 32, 16, 0, 254, 253, 1, 0, 0, 0, 254,
		255, 1, 0, 0, 0, 255, 256, 1, 0, 0, 0, 256, 257, 5, 60, 0, 0, 257, 258,
		3, 20, 10, 0, 258, 259, 5, 61, 0, 0, 259, 260, 3, 58, 29, 0, 260, 31, 1,
		0, 0, 0, 261, 262, 7, 2, 0, 0, 262, 33, 1, 0, 0, 0, 263, 264, 5, 5, 0,
		0, 264, 265, 3, 58, 29, 0, 265, 35, 1, 0, 0, 0, 266, 267, 5, 47, 0, 0,
		267, 268, 3, 38, 19, 0, 268, 37, 1, 0, 0, 0, 269, 276, 5, 20, 0, 0, 270,
		276, 5, 21, 0, 0, 271, 272, 5, 22, 0, 0, 272, 273, 5, 86, 0, 0, 273, 276,
		...
		43, 1, 0, 0, 0, 284, 285, 5, 51, 0, 0, 285, 286, 5, 7, 0, 0, 286, 287,
		3, 46, 23, 0, 287, 45, 1, 0, 0, 0, 288, 293, 3, 72, 36, 0, 289, 290, 5,
		75, 0, 0, 290, 292, 3, 72, 36, 0, 291, 289, 1, 0, 0, 0, 292, 295, 1, 0,
		0, 0, 293, 291, 1, 0, 0, 0, 293, 294, 1, 0, 0, 0, 294, 47, 1, 0, 0, 0,
		295, 293, 1, 0, 0, 0, 296, 297, 5, 52, 0, 0, 297, 298, 3, 58, 29, 0, 298,
		49, 1, 0, 0, 0, 299, 300, 5, 6, 0, 0, 300, 301, 5, 7, 0, 0, 301, 306, 3,
		76, 38, 0, 302, 303, 5, 75, 0, 0, 303, 305, 3, 76, 38, 0, 304, 302, 1,
		0, 0, 0, 305, 308, 1, 0, 0, 0, 306, 304, 1, 0, 0, 0, 306, 307, 1, 0, 0,
		0, 307, 51, 1, 0, 0, 0, 308, 306, 1, 0, 0, 0, 309, 310, 5, 8, 0, 0, 310,
		311, 5, 86, 0, 0, 311, 53, 1, 0, 0, 0, 312, 323, 5, 53, 0, 0, 313, 314,
		5, 54, 0, 0, 314, 315, 5, 55, 0, 0, 315, 319, 5, 56, 0, 0, 316, 317, 5,
		57, 0, 0, 317, 318, 5, 58, 0, 0, 318, 320, 3, 28, 14, 0, 319, 316, 1, 0,
		0, 0, 319, 320, 1, 0, 0, 0, 320, 324, 1, 0, 0, 0, 321, 322, 5, 59, 0, 0,
		...
		5, 76, 0, 0, 343, 344, 3, 64, 32, 0, 344, 345, 5, 77, 0, 0, 345, 365, 1,
		0, 0, 0, 346, 347, 3, 62, 31, 0, 347, 348, 5, 16, 0, 0, 348, 349, 5, 88,
		0, 0, 349, 365, 1, 0, 0, 0, 350, 351, 5, 76, 0, 0, 351, 352, 3, 58, 29,
		0, 352, 353, 5, 77, 0, 0, 353, 365, 1, 0, 0, 0, 354, 355, 3, 62, 31, 0,
		...
		1, 0, 0, 0, 369, 63, 1, 0, 0, 0, 370, 375, 3, 78, 39, 0, 371, 372, 5, 75,
		...
		71, 1, 0, 0, 0, 387, 399, 5, 85, 0, 0, 388, 389, 3, 56, 28, 0, 389, 390,
		5, 74, 0, 0, 390, 391, 5, 85, 0, 0, 391, 399, 1, 0, 0, 0, 392, 393, 3,
		56, 28, 0, 393, 394, 5, 74, 0, 0, 394, 395, 5, 85, 0, 0, 395, 396, 5, 74,
		0, 0, 396, 397, 5, 85, 0, 0, 397, 399, 1, 0, 0, 0, 398, 387, 1, 0, 0, 0,
		398, 388, 1, 0, 0, 0, 398, 392, 1, 0, 0, 0, 399, 73, 1, 0, 0, 0, 400, 405,
		3, 76, 38, 0, 401, 402, 5, 75, 0, 0, 402, 404, 3, 76, 38, 0, 403, 401,
...
const (
	...
	ServiceRadarQueryLanguageParserSTREAM_KW       = 46
	ServiceRadarQueryLanguageParserFROM            = 47
	ServiceRadarQueryLanguageParserTABLE_KW        = 48
	ServiceRadarQueryLanguageParserTUMBLE          = 49
	ServiceRadarQueryLanguageParserHOP             = 50
	ServiceRadarQueryLanguageParserGROUP_KW        = 51
	ServiceRadarQueryLanguageParserHAVING          = 52
	ServiceRadarQueryLanguageParserEMIT            = 53
	ServiceRadarQueryLanguageParserAFTER           = 54
	ServiceRadarQueryLanguageParserWINDOW_KW       = 55
	ServiceRadarQueryLanguageParserCLOSE           = 56
	ServiceRadarQueryLanguageParserWITH_KW         = 57
	ServiceRadarQueryLanguageParserDELAY           = 58
	ServiceRadarQueryLanguageParserPERIODIC        = 59
	ServiceRadarQueryLanguageParserJOIN            = 60
	ServiceRadarQueryLanguageParserON              = 61
	ServiceRadarQueryLanguageParserAS              = 62
	ServiceRadarQueryLanguageParserLEFT            = 63
	ServiceRadarQueryLanguageParserRIGHT           = 64
	ServiceRadarQueryLanguageParserINNER           = 65
	ServiceRadarQueryLanguageParserEQ              = 66
	ServiceRadarQueryLanguageParserNEQ             = 67
	ServiceRadarQueryLanguageParserGT              = 68
	ServiceRadarQueryLanguageParserGTE             = 69
	ServiceRadarQueryLanguageParserLT              = 70
	ServiceRadarQueryLanguageParserLTE             = 71
	ServiceRadarQueryLanguageParserLIKE            = 72
	ServiceRadarQueryLanguageParserBOOLEAN         = 73
	ServiceRadarQueryLanguageParserDOT             = 74
	ServiceRadarQueryLanguageParserCOMMA           = 75
	ServiceRadarQueryLanguageParserLPAREN          = 76
	ServiceRadarQueryLanguageParserRPAREN          = 77
	ServiceRadarQueryLanguageParserAPOSTROPHE      = 78
	ServiceRadarQueryLanguageParserQUOTE           = 79
	ServiceRadarQueryLanguageParserSTAR            = 80
	ServiceRadarQueryLanguageParserSECONDS_UNIT    = 81
	ServiceRadarQueryLanguageParserMINUTES_UNIT    = 82
	ServiceRadarQueryLanguageParserHOURS_UNIT      = 83
	ServiceRadarQueryLanguageParserDAYS_UNIT       = 84
	ServiceRadarQueryLanguageParserID              = 85
	ServiceRadarQueryLanguageParserINTEGER         = 86
	ServiceRadarQueryLanguageParserFLOAT           = 87
	ServiceRadarQueryLanguageParserSTRING          = 88
	ServiceRadarQueryLanguageParserTIMESTAMP       = 89
	ServiceRadarQueryLanguageParserIPADDRESS       = 90
	ServiceRadarQueryLanguageParserMACADDRESS      = 91
	ServiceRadarQueryLanguageParserWS              = 92
)
...
func (p *ServiceRadarQueryLanguageParser) StreamStatement() (localctx IStreamStatementContext) {
	...
	if ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&70368478887936) != 0) || ((int64((_la-73)) & ^0x3f) == 0 && ((int64(1)<<(_la-73))&520321) != 0) {
		{
			p.SetState(144)
			p.SelectList()
		}
	...
	for (int64((_la-60)) & ^0x3f) == 0 && ((int64(1)<<(_la-60))&57) != 0 {
		{
			p.SetState(149)
			p.JoinPart()
		}
...
func (p *ServiceRadarQueryLanguageParser) Duration() (localctx IDurationContext) {
	...
	}
	{
		...
		if !((int64((_la-81)) & ^0x3f) == 0 && ((int64(1)<<(_la-81))&15) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *ServiceRadarQueryLanguageParser) Entity() (localctx IEntityContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&70368475742208) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *ServiceRadarQueryLanguageParser) Value() (localctx IValueContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == ServiceRadarQueryLanguageParserTODAY || _la == ServiceRadarQueryLanguageParserYESTERDAY || ((int64((_la-73)) & ^0x3f) == 0 && ((int64(1)<<(_la-73))&516097) != 0)) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
