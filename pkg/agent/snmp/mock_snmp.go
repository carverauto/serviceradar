...
// Source: github.com/carverauto/serviceradar/pkg/agent/snmp (interfaces: Collector,Aggregator,Service,CollectorFactory,AggregatorFactory,SNMPClient)
//
// Generated by this command:
//
//	mockgen -destination=mock_snmp.go -package=snmp github.com/carverauto/serviceradar/pkg/agent/snmp Collector,Aggregator,Service,CollectorFactory,AggregatorFactory,SNMPClient
//
