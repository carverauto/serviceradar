...
// Mmsghdr represents the mmsghdr struct for ARM architecture
// This matches the C struct mmsghdr layout on 32-bit ARM systems
...
// sendmmsg wraps the sendmmsg system call for ARM
