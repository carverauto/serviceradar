...
func NewNetworkSweeper(config *models.Config, store Store, processor ResultProcessor, kvStore KVStore, configKey string) (*NetworkSweeper, error) {
	if config == nil {
...
// Remaining methods (scanAndProcess, runSweep, etc.) remain unchanged...
