---- MODULE Trace_gateway_sync_revival ----
...
TheLog == <<
  ...
  [status |-> ("d1" :> "live"), reason |-> ("d1" :> "none"), owner |-> ("i1" :> "d1"), ipOf |-> ("d1" :> "p1"), audit |-> <<>>, work |-> {}, act |-> [name |-> "GatewaySync", u |-> "d1", v |-> NoDev, row |-> 0, stale |-> FALSE, bumped |-> {"d1"}]]
>>
====
