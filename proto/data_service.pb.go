...
// ListObjectsRequest filters object metadata listing.
type ListObjectsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Prefix        string                 `protobuf:"bytes,1,opt,name=prefix,proto3" json:"prefix,omitempty"`                        // Optional object key prefix.
	Domain        string                 `protobuf:"bytes,2,opt,name=domain,proto3" json:"domain,omitempty"`                        // Optional JetStream domain name.
	PageSize      uint32                 `protobuf:"varint,3,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`   // Requested page size; the server applies a maximum.
	PageToken     string                 `protobuf:"bytes,4,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"` // Opaque page token returned by a previous response.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListObjectsRequest) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
// ListObjectsResponse returns object metadata without payload bytes.
...
const file_data_service_proto_rawDesc = "" +
	...
	"\aobjects\x18\x01 \x03(\v2\x11.proto.ObjectInfoR\aobjects\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\x89\x03\n" +
	"\vDataService\x12I\n" +
	...
	"\rGetObjectInfo\x12\x1b.proto.GetObjectInfoRequest\x1a\x1c.proto.GetObjectInfoResponse\"\x00\x12F\n" +
	"\vListObjects\x12\x19.proto.ListObjectsRequest\x1a\x1a.proto.ListObjectsResponse\"\x00B*Z(github.com/carverauto/serviceradar/protob\x06proto3"
...
var file_data_service_proto_goTypes = []any{
	...
	(*ListObjectsRequest)(nil),    // 10: proto.ListObjectsRequest
	(*ListObjectsResponse)(nil),   // 11: proto.ListObjectsResponse
	nil,                           // 12: proto.ObjectMetadata.AttributesEntry
}
var file_data_service_proto_depIdxs = []int32{
	12, // 0: proto.ObjectMetadata.attributes:type_name -> proto.ObjectMetadata.AttributesEntry
	...
	2,  // 6: proto.ListObjectsResponse.objects:type_name -> proto.ObjectInfo
	1,  // 7: proto.DataService.UploadObject:input_type -> proto.ObjectUploadChunk
	4,  // 8: proto.DataService.DownloadObject:input_type -> proto.DownloadObjectRequest
	6,  // 9: proto.DataService.DeleteObject:input_type -> proto.DeleteObjectRequest
	8,  // 10: proto.DataService.GetObjectInfo:input_type -> proto.GetObjectInfoRequest
	10, // 11: proto.DataService.ListObjects:input_type -> proto.ListObjectsRequest
	3,  // 12: proto.DataService.UploadObject:output_type -> proto.UploadObjectResponse
	5,  // 13: proto.DataService.DownloadObject:output_type -> proto.ObjectDownloadChunk
	7,  // 14: proto.DataService.DeleteObject:output_type -> proto.DeleteObjectResponse
	9,  // 15: proto.DataService.GetObjectInfo:output_type -> proto.GetObjectInfoResponse
	11, // 16: proto.DataService.ListObjects:output_type -> proto.ListObjectsResponse
