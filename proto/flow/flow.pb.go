...
func (x *FlowAttribution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlowAttribution) ProtoMessage() {}

func (x *FlowAttribution) ProtoReflect() protoreflect.Message {
	mi := &file_flow_flow_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlowAttribution.ProtoReflect.Descriptor instead.
func (*FlowAttribution) Descriptor() ([]byte, []int) {
	return file_flow_flow_proto_rawDescGZIP(), []int{1}
}

func (x *FlowAttribution) GetPid() uint32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *FlowAttribution) GetComm() string {
	if x != nil {
		return x.Comm
	}
	return ""
...
func (x *FlowAttribution) GetUid() uint32 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *FlowAttribution) GetContainerId() string {
	if x != nil {
...
type AttributedFlowMessage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Must be "attributed_flow"; kept as a string to match the existing
	// event-writer contract style.
	EventType     string           `protobuf:"bytes,1,opt,name=event_type,json=eventType,proto3" json:"event_type,omitempty"`
	Flow          *FlowMessage     `protobuf:"bytes,2,opt,name=flow,proto3" json:"flow,omitempty"`
	Attribution   *FlowAttribution `protobuf:"bytes,3,opt,name=attribution,proto3" json:"attribution,omitempty"`
...
func (x *AttributedFlowMessage) Reset() {
	*x = AttributedFlowMessage{}
	mi := &file_flow_flow_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttributedFlowMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttributedFlowMessage) ProtoMessage() {}

func (x *AttributedFlowMessage) ProtoReflect() protoreflect.Message {
	mi := &file_flow_flow_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttributedFlowMessage.ProtoReflect.Descriptor instead.
func (*AttributedFlowMessage) Descriptor() ([]byte, []int) {
	return file_flow_flow_proto_rawDescGZIP(), []int{2}
}

func (x *AttributedFlowMessage) GetEventType() string {
	if x != nil {
		return x.EventType
	}
	return ""
...
func (x *AttributedFlowMessage) GetFlow() *FlowMessage {
	if x != nil {
		return x.Flow
	}
	return nil
...
func (x *AttributedFlowMessage) GetAttribution() *FlowAttribution {
	if x != nil {
...
func (x *AttributedFlowMessage) GetAgentId() string {
	if x != nil {
		return x.AgentId
	}
	return ""
...
func (x *AttributedFlowMessage) GetPartition() string {
	if x != nil {
		return x.Partition
	}
	return ""
...
const file_flow_flow_proto_rawDesc = "" +
	"\n" +
	"\x0fflow/flow.proto\x12\x06flowpb\"\xbb\x10\n" +
	"\vFlowMessage\x120\n" +
	...
	"\x04flow\x18\x02 \x01(\v2\x13.flowpb.FlowMessageR\x04flow\x129\n" +
	"\vattribution\x18\x03 \x01(\v2\x17.flowpb.FlowAttributionR\vattribution\x12\x19\n" +
	"\bagent_id\x18\x04 \x01(\tR\aagentId\x12\x1c\n" +
	"\tpartition\x18\x05 \x01(\tR\tpartitionB6Z4github.com/carverauto/serviceradar/proto/flow;flowpbb\x06proto3"
...
var file_flow_flow_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_flow_flow_proto_goTypes = []any{
	...
	(*FlowAttribution)(nil),       // 3: flowpb.FlowAttribution
	(*AttributedFlowMessage)(nil), // 4: flowpb.AttributedFlowMessage
}
var file_flow_flow_proto_depIdxs = []int32{
	...
	2, // 2: flowpb.AttributedFlowMessage.flow:type_name -> flowpb.FlowMessage
	3, // 3: flowpb.AttributedFlowMessage.attribution:type_name -> flowpb.FlowAttribution
