...
const (
	...
	AgentGatewayService_ResolveAutomationLaunchEnvelope_FullMethodName = "/monitoring.AgentGatewayService/ResolveAutomationLaunchEnvelope"
)
...
type AgentGatewayServiceClient interface {
	...
	// StreamConfig streams chunked agent configuration for large payloads.
	StreamConfig(ctx context.Context, in *AgentConfigRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AgentConfigChunk], error)
	...
	// ResolveAutomationLaunchEnvelope releases one callback bearer to the exact
	// mTLS-authenticated agent and command. It is intentionally separate from
	// the reusable credential-broker contract.
	ResolveAutomationLaunchEnvelope(ctx context.Context, in *AutomationLaunchEnvelopeResolveRequest, opts ...grpc.CallOption) (*AutomationLaunchEnvelopeResolveResponse, error)
}
...
func (c *agentGatewayServiceClient) StreamConfig(ctx context.Context, in *AgentConfigRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AgentConfigChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AgentGatewayService_ServiceDesc.Streams[0], AgentGatewayService_StreamConfig_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[AgentConfigRequest, AgentConfigChunk]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentGatewayService_StreamConfigClient = grpc.ServerStreamingClient[AgentConfigChunk]
...
func (c *agentGatewayServiceClient) StreamStatus(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[GatewayStatusChunk, GatewayStatusResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AgentGatewayService_ServiceDesc.Streams[1], AgentGatewayService_StreamStatus_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentGatewayServiceClient) ControlStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ControlStreamRequest, ControlStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AgentGatewayService_ServiceDesc.Streams[2], AgentGatewayService_ControlStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentGatewayServiceClient) ResolveAutomationLaunchEnvelope(ctx context.Context, in *AutomationLaunchEnvelopeResolveRequest, opts ...grpc.CallOption) (*AutomationLaunchEnvelopeResolveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AutomationLaunchEnvelopeResolveResponse)
	err := c.cc.Invoke(ctx, AgentGatewayService_ResolveAutomationLaunchEnvelope_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentGatewayServiceServer interface {
	...
	// StreamConfig streams chunked agent configuration for large payloads.
	StreamConfig(*AgentConfigRequest, grpc.ServerStreamingServer[AgentConfigChunk]) error
	// PushStatus sends a batch of service statuses from the agent to the gateway.
	...
	// mTLS-authenticated agent and command. It is intentionally separate from
	// the reusable credential-broker contract.
	ResolveAutomationLaunchEnvelope(context.Context, *AutomationLaunchEnvelopeResolveRequest) (*AutomationLaunchEnvelopeResolveResponse, error)
...
func (UnimplementedAgentGatewayServiceServer) StreamConfig(*AgentConfigRequest, grpc.ServerStreamingServer[AgentConfigChunk]) error {
...
func (UnimplementedAgentGatewayServiceServer) ResolveAutomationLaunchEnvelope(context.Context, *AutomationLaunchEnvelopeResolveRequest) (*AutomationLaunchEnvelopeResolveResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResolveAutomationLaunchEnvelope not implemented")
}
...
func _AgentGatewayService_StreamConfig_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(AgentConfigRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AgentGatewayServiceServer).StreamConfig(m, &grpc.GenericServerStream[AgentConfigRequest, AgentConfigChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentGatewayService_StreamConfigServer = grpc.ServerStreamingServer[AgentConfigChunk]
...
func _AgentGatewayService_ResolveAutomationLaunchEnvelope_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AutomationLaunchEnvelopeResolveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentGatewayServiceServer).ResolveAutomationLaunchEnvelope(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentGatewayService_ResolveAutomationLaunchEnvelope_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentGatewayServiceServer).ResolveAutomationLaunchEnvelope(ctx, req.(*AutomationLaunchEnvelopeResolveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentGatewayService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveAutomationLaunchEnvelope",
			Handler:    _AgentGatewayService_ResolveAutomationLaunchEnvelope_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "StreamConfig",
			Handler:       _AgentGatewayService_StreamConfig_Handler,
			ServerStreams: true,
		},
		{
