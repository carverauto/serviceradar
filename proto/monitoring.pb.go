...
// FileChunk carries a chunk of file data during upload or download.
type FileChunk struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SessionId     string                 `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`       // Links to TftpSession resource
	Data          []byte                 `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`                                  // File data chunk (recommended 64KB)
	Offset        int64                  `protobuf:"varint,3,opt,name=offset,proto3" json:"offset,omitempty"`                             // Byte offset of this chunk in the file
	TotalSize     int64                  `protobuf:"varint,4,opt,name=total_size,json=totalSize,proto3" json:"total_size,omitempty"`      // Total file size in bytes (set in first chunk, 0 if unknown)
	ContentHash   string                 `protobuf:"bytes,5,opt,name=content_hash,json=contentHash,proto3" json:"content_hash,omitempty"` // SHA-256 hash of entire file (set in last chunk only)
	IsLast        bool                   `protobuf:"varint,6,opt,name=is_last,json=isLast,proto3" json:"is_last,omitempty"`               // True for the final chunk
	Filename      string                 `protobuf:"bytes,7,opt,name=filename,proto3" json:"filename,omitempty"`                          // Original filename (set in first chunk)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FileChunk) GetContentHash() string {
	if x != nil {
...
// FileUploadResponse is returned after a complete file upload.
type FileUploadResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`                                  // Whether the upload was accepted and stored
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`                                   // Human-readable status or error message
	BytesReceived int64                  `protobuf:"varint,3,opt,name=bytes_received,json=bytesReceived,proto3" json:"bytes_received,omitempty"` // Total bytes received
	ContentHash   string                 `protobuf:"bytes,4,opt,name=content_hash,json=contentHash,proto3" json:"content_hash,omitempty"`        // SHA-256 hash computed by receiver for verification
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FileUploadResponse) GetContentHash() string {
	if x != nil {
		return x.ContentHash
	}
	return ""
...
// FileDownloadRequest initiates a file download from gateway to agent.
type FileDownloadRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SessionId     string                 `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`          // TftpSession ID (used to look up which file to serve)
	AgentId       string                 `protobuf:"bytes,2,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty"`                // Agent requesting the download
	ImageId       string                 `protobuf:"bytes,3,opt,name=image_id,json=imageId,proto3" json:"image_id,omitempty"`                // SoftwareImage ID to download (for serve-mode staging)
	ExpectedHash  string                 `protobuf:"bytes,4,opt,name=expected_hash,json=expectedHash,proto3" json:"expected_hash,omitempty"` // Expected SHA-256 hash for verification after download
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FileDownloadRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *FileDownloadRequest) GetImageId() string {
	if x != nil {
		return x.ImageId
	}
	return ""
...
func (x *FileDownloadRequest) GetExpectedHash() string {
	if x != nil {
...
const file_monitoring_proto_rawDesc = "" +
	...
	"\rStreamResults\x12\x1a.monitoring.ResultsRequest\x1a\x18.monitoring.ResultsChunk\"\x000\x012\xcc\x04\n" +
	...
	"\rControlStream\x12 .monitoring.ControlStreamRequest\x1a!.monitoring.ControlStreamResponse\"\x00(\x010\x01\x12G\n" +
	"\n" +
	"UploadFile\x12\x15.monitoring.FileChunk\x1a\x1e.monitoring.FileUploadResponse\"\x00(\x01\x12J\n" +
	"\fDownloadFile\x12\x1f.monitoring.FileDownloadRequest\x1a\x15.monitoring.FileChunk\"\x000\x01B*Z(github.com/carverauto/serviceradar/protob\x06proto3"
...
var file_monitoring_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_monitoring_proto_goTypes = []any{
	...
	(*FileChunk)(nil),                 // 32: monitoring.FileChunk
	(*FileUploadResponse)(nil),        // 33: monitoring.FileUploadResponse
	(*FileDownloadRequest)(nil),       // 34: monitoring.FileDownloadRequest
	(*PluginConfig)(nil),              // 35: monitoring.PluginConfig
	(*PluginEngineLimits)(nil),        // 36: monitoring.PluginEngineLimits
	(*PluginAssignmentConfig)(nil),    // 37: monitoring.PluginAssignmentConfig
	(*SysmonConfig)(nil),              // 38: monitoring.SysmonConfig
	(*AgentCheckConfig)(nil),          // 39: monitoring.AgentCheckConfig
	(*SNMPConfig)(nil),                // 40: monitoring.SNMPConfig
	(*SNMPTargetConfig)(nil),          // 41: monitoring.SNMPTargetConfig
	(*SNMPv3Auth)(nil),                // 42: monitoring.SNMPv3Auth
	(*SNMPOIDConfig)(nil),             // 43: monitoring.SNMPOIDConfig
	nil,                               // 44: monitoring.AgentHelloRequest.LabelsEntry
	nil,                               // 45: monitoring.SysmonConfig.ThresholdsEntry
	nil,                               // 46: monitoring.AgentCheckConfig.SettingsEntry
}
var file_monitoring_proto_depIdxs = []int32{
	...
	44, // 7: monitoring.AgentHelloRequest.labels:type_name -> monitoring.AgentHelloRequest.LabelsEntry
	39, // 8: monitoring.AgentConfigResponse.checks:type_name -> monitoring.AgentCheckConfig
	38, // 9: monitoring.AgentConfigResponse.sysmon_config:type_name -> monitoring.SysmonConfig
	40, // 10: monitoring.AgentConfigResponse.snmp_config:type_name -> monitoring.SNMPConfig
	35, // 11: monitoring.AgentConfigResponse.plugin_config:type_name -> monitoring.PluginConfig
	...
	37, // 19: monitoring.PluginConfig.assignments:type_name -> monitoring.PluginAssignmentConfig
	36, // 20: monitoring.PluginConfig.engine_limits:type_name -> monitoring.PluginEngineLimits
	45, // 21: monitoring.SysmonConfig.thresholds:type_name -> monitoring.SysmonConfig.ThresholdsEntry
	46, // 22: monitoring.AgentCheckConfig.settings:type_name -> monitoring.AgentCheckConfig.SettingsEntry
	41, // 23: monitoring.SNMPConfig.targets:type_name -> monitoring.SNMPTargetConfig
	0,  // 24: monitoring.SNMPTargetConfig.version:type_name -> monitoring.SNMPVersion
	42, // 25: monitoring.SNMPTargetConfig.v3_auth:type_name -> monitoring.SNMPv3Auth
	43, // 26: monitoring.SNMPTargetConfig.oids:type_name -> monitoring.SNMPOIDConfig
	...
	7,  // 31: monitoring.AgentService.GetStatus:input_type -> monitoring.StatusRequest
	8,  // 32: monitoring.AgentService.GetResults:input_type -> monitoring.ResultsRequest
	8,  // 33: monitoring.AgentService.StreamResults:input_type -> monitoring.ResultsRequest
	20, // 34: monitoring.AgentGatewayService.Hello:input_type -> monitoring.AgentHelloRequest
	22, // 35: monitoring.AgentGatewayService.GetConfig:input_type -> monitoring.AgentConfigRequest
	16, // 36: monitoring.AgentGatewayService.PushStatus:input_type -> monitoring.GatewayStatusRequest
	18, // 37: monitoring.AgentGatewayService.StreamStatus:input_type -> monitoring.GatewayStatusChunk
	30, // 38: monitoring.AgentGatewayService.ControlStream:input_type -> monitoring.ControlStreamRequest
	32, // 39: monitoring.AgentGatewayService.UploadFile:input_type -> monitoring.FileChunk
	34, // 40: monitoring.AgentGatewayService.DownloadFile:input_type -> monitoring.FileDownloadRequest
	9,  // 41: monitoring.AgentService.GetStatus:output_type -> monitoring.StatusResponse
	10, // 42: monitoring.AgentService.GetResults:output_type -> monitoring.ResultsResponse
	13, // 43: monitoring.AgentService.StreamResults:output_type -> monitoring.ResultsChunk
	21, // 44: monitoring.AgentGatewayService.Hello:output_type -> monitoring.AgentHelloResponse
	23, // 45: monitoring.AgentGatewayService.GetConfig:output_type -> monitoring.AgentConfigResponse
	17, // 46: monitoring.AgentGatewayService.PushStatus:output_type -> monitoring.GatewayStatusResponse
	17, // 47: monitoring.AgentGatewayService.StreamStatus:output_type -> monitoring.GatewayStatusResponse
	31, // 48: monitoring.AgentGatewayService.ControlStream:output_type -> monitoring.ControlStreamResponse
	33, // 49: monitoring.AgentGatewayService.UploadFile:output_type -> monitoring.FileUploadResponse
	32, // 50: monitoring.AgentGatewayService.DownloadFile:output_type -> monitoring.FileChunk
