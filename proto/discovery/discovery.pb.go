...
type InterfaceMetric struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Name           string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`                                         // Human-readable metric name (e.g., "ifInOctets")
	Oid            string                 `protobuf:"bytes,2,opt,name=oid,proto3" json:"oid,omitempty"`                                           // SNMP OID in dotted notation
	DataType       string                 `protobuf:"bytes,3,opt,name=data_type,json=dataType,proto3" json:"data_type,omitempty"`                 // Data type: "counter" or "gauge"
	Supports_64Bit bool                   `protobuf:"varint,4,opt,name=supports_64bit,json=supports64bit,proto3" json:"supports_64bit,omitempty"` // Whether 64-bit (HC) counter is available
	Oid_64Bit      string                 `protobuf:"bytes,5,opt,name=oid_64bit,json=oid64bit,proto3" json:"oid_64bit,omitempty"`                 // 64-bit OID if supports_64bit is true
	Category       string                 `protobuf:"bytes,6,opt,name=category,proto3" json:"category,omitempty"`                                 // Category for visualization: "traffic", "errors", "packets", "environmental", "status"
	Unit           string                 `protobuf:"bytes,7,opt,name=unit,proto3" json:"unit,omitempty"`                                         // Unit of measurement: "bytes", "packets", "errors", "celsius", "rpm", "percent", "watts"
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *InterfaceMetric) GetOid() string {
	if x != nil {
		return x.Oid
	}
	return ""
...
func (x *InterfaceMetric) GetDataType() string {
	if x != nil {
		return x.DataType
	}
	return ""
...
func (x *InterfaceMetric) GetSupports_64Bit() bool {
	if x != nil {
		return x.Supports_64Bit
	}
	return false
}

func (x *InterfaceMetric) GetOid_64Bit() string {
	if x != nil {
		return x.Oid_64Bit
	}
	return ""
...
func (x *InterfaceMetric) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *InterfaceMetric) GetUnit() string {
	if x != nil {
		return x.Unit
	}
	return ""
...
type DiscoveredInterface struct {
	...
	AvailableMetrics []*InterfaceMetric      `protobuf:"bytes,14,rep,name=available_metrics,json=availableMetrics,proto3" json:"available_metrics,omitempty"`                                   // Available SNMP metrics for this interface
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *DiscoveredInterface) GetAvailableMetrics() []*InterfaceMetric {
	if x != nil {
...
const file_discovery_discovery_proto_rawDesc = "" +
	...
	"\x0esupports_64bit\x18\x04 \x01(\bR\rsupports64bit\x12\x1b\n" +
	"\toid_64bit\x18\x05 \x01(\tR\boid64bit\x12\x1a\n" +
	"\bcategory\x18\x06 \x01(\tR\bcategory\x12\x12\n" +
	"\x04unit\x18\a \x01(\tR\x04unit\"\xf4\x04\n" +
	...
	"\bmetadata\x18\r \x03(\v2,.discovery.DiscoveredInterface.MetadataEntryR\bmetadata\x12G\n" +
	"\x11available_metrics\x18\x0e \x03(\v2\x1a.discovery.InterfaceMetricR\x10availableMetrics\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
