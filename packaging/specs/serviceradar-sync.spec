...
install -m 644 %{_sourcedir}/packaging/sync/systemd/serviceradar-sync.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/packaging/sync/config/sync.json %{buildroot}/etc/serviceradar/
