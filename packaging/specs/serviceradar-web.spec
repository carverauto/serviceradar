...
install -m 644 %{_sourcedir}/packaging/web/systemd/serviceradar-web.service %{buildroot}/lib/systemd/system/
install -m 644 %{_sourcedir}/packaging/web/config/web.json %{buildroot}/etc/serviceradar/
install -m 644 %{_sourcedir}/packaging/web/config/nginx.conf %{buildroot}/etc/nginx/conf.d/serviceradar-web.conf

# Install SELinux policy file
install -m 644 %{_sourcedir}/packaging/web/selinux/serviceradar-nginx.te %{buildroot}/etc/serviceradar/selinux/
