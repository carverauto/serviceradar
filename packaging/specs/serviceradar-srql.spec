...
install -m 644 %{_sourcedir}/packaging/srql/systemd/serviceradar-srql.service %{buildroot}/lib/systemd/system/
install -m 640 %{_sourcedir}/packaging/srql/config/srql.env %{buildroot}/etc/serviceradar/
