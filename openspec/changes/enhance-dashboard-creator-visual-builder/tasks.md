...
- [ ] 2.4 Add tests for builder parse/build round trips in dashboard authoring.
...
- [ ] 4.4 Validate visual configs against preview metadata before save.
...
- [ ] 5.3 Add boolean/status/icon renderers and sparkline-in-table rendering where data shape supports it.
- [ ] 5.4 Add tests for table rendering of nested JSON, booleans, status fields, and sparse values.

## 6. Validation
- [ ] 6.1 Run focused dashboard Ash/resource tests.
- [ ] 6.2 Run focused LiveView tests for dashboard creation, builder editing, output bindings, and table renderers.
...
- [ ] 7.6 Add tests for missing default package diagnostics, accessible dashboard switching, SRQL dashboard search, and shell title behavior.
