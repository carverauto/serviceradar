...
- [x] 3.2.55 Run the connector-linked helper's runtime open path through verified TLS trust and connector-config preflight before returning connector-not-ready.
