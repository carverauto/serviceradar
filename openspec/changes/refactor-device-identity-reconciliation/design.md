...
- **D6 — Versioned, stable integration identifiers.** See the current [identifier vocabulary](../../../docs/docs/dire-identity-model.md#identifier-vocabulary) for the admissibility contract and authoritative format reference.
