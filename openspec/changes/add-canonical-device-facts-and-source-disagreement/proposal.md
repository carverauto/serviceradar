...
- Promote existing Armis attachment metadata into canonical facts and backfill current rows that already carry Armis attachment metadata such as `switch01.example.com:gi1/0/7` and VLAN `200`.
