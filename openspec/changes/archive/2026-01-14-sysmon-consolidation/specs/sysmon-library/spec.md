...
Specifies the requirements for the unified `pkg/sysmon` library that replaces both the Rust `sysmon` checker and Go `sysmon-osx` checker with a single cross-platform Go implementation.
