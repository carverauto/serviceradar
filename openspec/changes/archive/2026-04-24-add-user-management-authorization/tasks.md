...
- [ ] 1.3 Add Permit dependencies + permissions module for admin authorization rules
- [ ] 1.4 Remove Ash policy enforcement for user management and authorization settings
- [ ] 1.5 Add audit events for user lifecycle and authz setting changes
...
## 4. Tests & Docs
- [ ] 4.1 Add backend tests for role mapping + Permit authorization rules
- [ ] 4.2 Add UI tests/coverage for auth settings flows + admin authorization gates
