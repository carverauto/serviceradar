...
## What Changes
- **BREAKING** Remove poller services, resources, configuration paths, and UI surfaces (excluding the UBNT mapper poller).
...
- Defer legacy Swagger/OpenAPI cleanup (scheduled for removal later).
