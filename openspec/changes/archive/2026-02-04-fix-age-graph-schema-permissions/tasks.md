...
- [x] 1.5 Ensure startup migrations grant USAGE/CREATE/ALL privileges on the canonical graph schema to the application role.
- [x] 1.6 Ensure startup migrations transfer ownership of AGE graph schema/label tables to the application role.
- [x] 1.7 Add/adjust tests to confirm graph upserts succeed without schema permission errors.
