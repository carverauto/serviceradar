...
| Desktop/RDP | Separate proposal required | Renderer, redirection controls, bandwidth quotas, recording policy | No approved Teleport source reuse. Evaluate protocol libraries separately. |
