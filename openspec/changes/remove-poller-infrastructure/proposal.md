...
- Affected code: Elixir core (resources, registries, telemetry, onboarding), web-ng UI and tests, SRQL mappings, Docker compose configs/images, Go/Rust poller artifacts, documentation and runbooks.
