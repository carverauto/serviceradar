...
- Expose queued/running/polling/result-fetch states in Task History so users understand where results will appear after launch.
...
- Affected code:
  ...
  - `elixir/web-ng` Task History components for clear progress and result visibility.
