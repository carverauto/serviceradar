...
- [x] 1.3 Preserve explicit manual enqueue failure when a stale uniqueness conflict cannot be cleared immediately.
- [x] 1.4 Add regression tests for stale manual enqueue conflicts.
