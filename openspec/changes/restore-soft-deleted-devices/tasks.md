...
- [ ] 1.2 Add regression test asserting that a non-deletion update removes `_deleted` while explicit deletion updates keep it set.
...
- [ ] 2.2 `go test` for updated DB upsert logic
