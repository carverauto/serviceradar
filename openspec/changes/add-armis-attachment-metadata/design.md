...
4. Trigger an Armis sync and verify `ocsf_devices.metadata` includes keys such as `armis_access_switch`, `armis_vlan`, `armis_connection_type`, and `armis_dhcp_lease_type` when Armis returns them.
