...
- Affected code: shared core timezone catalog/validation, authenticated profile settings, shared Phoenix timestamp component and JavaScript hook, chart formatters, and timestamp-bearing `elixir/web-ng` views
