## 1. Implementation
- [x] 1.1 Fix first-party Proxmox plugin artifact/schema sync so generated agent config includes token material consistently.
- [x] 1.2 Extend the Proxmox plugin to collect guest NIC evidence from LXC/QEMU config and QEMU guest-agent network interfaces.
