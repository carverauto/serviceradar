...
- **WHEN** a client sends `in:wifi_sites region:REGION-1 sort:ap_count:desc limit:50`
...
- **GIVEN** AP observations exist for site `ZZA`
- **WHEN** a client sends `in:wifi_aps site_code:ZZA status:Down sort:name:asc`
