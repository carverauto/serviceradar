...
- [ ] 5.1 Document the mapping model under `docs/docs/`: sources, precedence, union semantics, and
      the difference between a role and a profile. ASCII only.
- [ ] 5.2 Document Microsoft Entra specifically: how to emit the groups claim, that it carries group
...
- [ ] 5.3 Worked example: an Entra group bound to a profile holding `plugins.stage`, which is what
