...
- [x] 2.8 Add browser UI for per-session SSH key upload/paste, optional client-only remembered keys, passphrase support, and browser-local key digest display without server-side key persistence.
