...
- **Affected code:**
  ...
  - `elixir/web-ng/lib/serviceradar_web_ng_web/controllers/srql_catalog_controller.ex` (new) + router entry — serves `/api/srql/catalog` with ETag.
  ...
  - Tests: a property test for the tokenizer; a Wallaby/LiveView test for the hook behavior in the navbar.
- **Non-goals:**
