...
**Date**: 2026-01-17
**Reason**: Superseded by `remove-ash-srql-adapter` change.

The Ash SRQL adapter approach was a workaround that duplicated Rust SRQL logic in Elixir. Instead of fixing bugs in the adapter, we removed it entirely and now use the Rust SRQL implementation directly.
