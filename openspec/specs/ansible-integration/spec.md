...
## Purpose
Define the deployed ServiceRadar/AWX controller persistence, inventory-sync assignment materialization, and controller lifecycle mechanics. Higher-level inventory identity and playbook execution behavior remains governed by active Ansible changes until separately reconciled and archived.
## Requirements
