...
six local fixes below were never going to land, and `.patch` files are a worse mechanism than
...
The diff should show exactly the six changes above and nothing else.
