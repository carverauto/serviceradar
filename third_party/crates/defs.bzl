...
_NORMAL_DEPENDENCIES = {
    ...
    "rust/flowgger": {
        _COMMON_CONDITION: {
            ...
            "rustls-pemfile": Label("//third_party/crates/rustls-pemfile-2.2.0:rustls_pemfile"),
            "serde": Label("//third_party/crates/serde-1.0.228:serde"),
            "serde_json": Label("//third_party/crates/serde_json-0.8.6:serde_json"),
    ...
    "rust/rperf-client": {
        _COMMON_CONDITION: {
            ...
            "tonic": Label("//third_party/crates/tonic-0.12.3:tonic"),
            "tonic-health": Label("//third_party/crates/tonic-health-0.12.3:tonic_health"),
            "tonic-reflection": Label("//third_party/crates/tonic-reflection-0.12.3:tonic_reflection"),
        },
    },
    "rust/srql": {
        _COMMON_CONDITION: {
            ...
            "tower-http": Label("//third_party/crates/tower-http-0.6.11:tower_http"),
            "tracing": Label("//third_party/crates/tracing-0.1.44:tracing"),
            "tracing-subscriber": Label("//third_party/crates/tracing-subscriber-0.3.23:tracing_subscriber"),
            "uuid": Label("//third_party/crates/uuid-1.23.1:uuid"),
        },
    ...
    "rust/workload-identity": {
        _COMMON_CONDITION: {
            "anyhow": Label("//third_party/crates/anyhow-1.0.102:anyhow"),
            "clap": Label("//third_party/crates/clap-4.6.1:clap"),
            "cri-api": Label("//third_party/crates/cri-api-0.2.0:cri_api"),
            "hyper-util": Label("//third_party/crates/hyper-util-0.1.20:hyper_util"),
            "log": Label("//third_party/crates/log-0.4.30:log"),
            "serde": Label("//third_party/crates/serde-1.0.228:serde"),
            "serde_json": Label("//third_party/crates/serde_json-1.0.150:serde_json"),
...
_BUILD_DEPENDENCIES = {
    ...
    "rust/addon-sdk": {
        _COMMON_CONDITION: {
            "tonic-build": Label("//third_party/crates/tonic-build-0.12.3:tonic_build"),
        },
    },
    "rust/anomaly-addon": {
    },
    ...
    "rust/netprobe": {
        _COMMON_CONDITION: {
            ...
            "prost-build": Label("//third_party/crates/prost-build-0.13.5:prost_build"),
            "quick-xml": Label("//third_party/crates/quick-xml-0.38.4:quick_xml"),
        },
    },
    "rust/otel": {
    ...
    "rust/rperf-client": {
        _COMMON_CONDITION: {
            "tonic-build": Label("//third_party/crates/tonic-build-0.12.3:tonic_build"),
            "which": Label("//third_party/crates/which-7.0.3:which"),
        },
    },
    "rust/srql": {
    },
...
_CONDITIONS = {
    ...
    "cfg(any(unix, target_os = \"wasi\", target_os = \"redox\"))": ["@rules_rust//rust/platform:aarch64-apple-darwin", "@rules_rust//rust/platform:aarch64-apple-ios", "@rules_rust//rust/platform:aarch64-apple-ios-sim", "@rules_rust//rust/platform:aarch64-linux-android", "@rules_rust//rust/platform:aarch64-unknown-fuchsia", "@rules_rust//rust/platform:aarch64-unknown-linux-gnu", "@rules_rust//rust/platform:aarch64-unknown-nixos-gnu", "@rules_rust//rust/platform:aarch64-unknown-nto-qnx710", "@rules_rust//rust/platform:arm-unknown-linux-gnueabi", "@rules_rust//rust/platform:armv7-linux-androideabi", "@rules_rust//rust/platform:armv7-unknown-linux-gnueabi", "@rules_rust//rust/platform:i686-apple-darwin", "@rules_rust//rust/platform:i686-linux-android", "@rules_rust//rust/platform:i686-unknown-freebsd", "@rules_rust//rust/platform:i686-unknown-linux-gnu", "@rules_rust//rust/platform:powerpc-unknown-linux-gnu", "@rules_rust//rust/platform:riscv64gc-unknown-linux-gnu", "@rules_rust//rust/platform:s390x-unknown-linux-gnu", "@rules_rust//rust/platform:wasm32-unknown-emscripten", "@rules_rust//rust/platform:wasm32-wasip1", "@rules_rust//rust/platform:wasm32-wasip1-threads", "@rules_rust//rust/platform:wasm32-wasip2", "@rules_rust//rust/platform:x86_64-apple-darwin", "@rules_rust//rust/platform:x86_64-apple-ios", "@rules_rust//rust/platform:x86_64-linux-android", "@rules_rust//rust/platform:x86_64-unknown-freebsd", "@rules_rust//rust/platform:x86_64-unknown-fuchsia", "@rules_rust//rust/platform:x86_64-unknown-linux-gnu", "@rules_rust//rust/platform:x86_64-unknown-nixos-gnu"],
