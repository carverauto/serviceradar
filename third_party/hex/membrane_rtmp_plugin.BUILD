...
mix_app(
    ...
    deps = [
        ...
        "@hex_membrane_file_plugin//:erlang_app",
        "@hex_membrane_flv_plugin//:erlang_app",
        "@hex_membrane_funnel_plugin//:erlang_app",
        "@hex_membrane_h264_format//:erlang_app",
        "@hex_membrane_h26x_plugin//:erlang_app",
        "@hex_membrane_precompiled_dependency_provider//:erlang_app",
        "@hex_unifex//:erlang_app",
        "@rules_elixir//elixir",
    ],
)
