...
{{- $cnpg.imageName -}}
{{- else -}}
{{- printf "%s:%s" (include "serviceradar.imageRepository" (dict "Values" .Values "name" "serviceradar-cnpg")) (default "18.3.0-sr5@sha256:c70e6cf66ba3608011eccd1fd93169133ed90d62613573eca6446fece8bbfd5d" $cnpg.imageTag) -}}
{{- end -}}
{{- end -}}
