...
public struct SurveySample: Identifiable, Codable {
    ...
    public init(id: UUID = UUID(), timestamp: TimeInterval = Date().timeIntervalSince1970, bssid: String, ssid: String, rssi: Double, frequency: Int, position: simd_float3, uncertainty: Float) {
        self.id = id
