...
var (
	...
	errRequiresGatewayFile   = errors.New("update-gateway requires -file")
	errUpdatingGatewayConfig = errors.New("failed to update gateway config file")
	errAgentNotFound         = errors.New("specified agent not found in gateway configuration")
	...
	errEnrollTokenRequired      = errors.New("enrollment token is required")
