...
//go:generate mockgen -destination=mock_sweeper.go -package=sweeper github.com/carverauto/serviceradar/go/pkg/sweeper Sweeper,ResultProcessor,Store,Reporter,SweepService,KVStore,ObjectStore,DeviceRegistryService
