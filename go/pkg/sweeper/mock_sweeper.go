...
// Source: github.com/carverauto/serviceradar/go/pkg/sweeper (interfaces: Sweeper,ResultProcessor,Store,Reporter,SweepService,KVStore,ObjectStore,DeviceRegistryService)
//
// Generated by this command:
//
//	mockgen -destination=mock_sweeper.go -package=sweeper github.com/carverauto/serviceradar/go/pkg/sweeper Sweeper,ResultProcessor,Store,Reporter,SweepService,KVStore,ObjectStore,DeviceRegistryService
//
...
func (m *MockObjectStore) DownloadObject(ctx context.Context, key string) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DownloadObject", ctx, key)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockObjectStoreMockRecorder) DownloadObject(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DownloadObject", reflect.TypeOf((*MockObjectStore)(nil).DownloadObject), ctx, key)
}
