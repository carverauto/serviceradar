...
//go:generate mockgen -destination=mock_snmp.go -package=snmp github.com/carverauto/serviceradar/go/pkg/agent/snmp Collector,Aggregator,Service,CollectorFactory,AggregatorFactory,SNMPClient
