...
type fileProgramSpecs struct {
	SrFileAccess    *ebpf.ProgramSpec `ebpf:"sr_file_access"`
	SrFileFaccessat *ebpf.ProgramSpec `ebpf:"sr_file_faccessat"`
	SrFileOpenat    *ebpf.ProgramSpec `ebpf:"sr_file_openat"`
}
...
type filePrograms struct {
	SrFileAccess    *ebpf.Program `ebpf:"sr_file_access"`
	SrFileFaccessat *ebpf.Program `ebpf:"sr_file_faccessat"`
	SrFileOpenat    *ebpf.Program `ebpf:"sr_file_openat"`
}
