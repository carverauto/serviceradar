...
```bash
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --all --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --all --non-interactive --checkers=rperf,snmp
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --core --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --core --non-interactive --checkers=dusk-checker
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --poller --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --poller --non-interactive --checkers=rperf,snmp
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --agent --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --agent --non-interactive --checkers=rperf,rperf-checker,snmp
```
...
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.31/install-serviceradar.sh | bash -s -- --poller --agent --non-interactive --checkers=rperf,snmp
```
