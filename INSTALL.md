...
```bash
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --all --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --all --non-interactive --checkers=rperf,snmp
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --core --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --core --non-interactive --checkers=dusk-checker
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --poller --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --poller --non-interactive --checkers=rperf,snmp
```
...
```bash
# Without checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --agent --non-interactive

# With checkers
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --agent --non-interactive --checkers=rperf,rperf-checker,snmp
```
...
curl -sSL https://github.com/carverauto/serviceradar/releases/download/1.0.37/install-serviceradar.sh | bash -s -- --poller --agent --non-interactive --checkers=rperf,snmp
```
...
curl -LO https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-agent_1.0.37.deb \
     ...
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-core_1.0.37.deb \
     -O https://github.com/carverauto/serviceradar/releases/download/1.0.37/serviceradar-web_1.0.37.deb

# Install components as needed
sudo dpkg -i serviceradar-agent_1.0.37.deb serviceradar-poller_1.0.37.deb serviceradar-core_1.0.37.deb serviceradar-web_1.0.37.deb
```
